        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    shipping_cost = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    ...
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    updated_by = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    row_version = table.Column<int>(type: "integer", rowVersion: true, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    delivery_note_id = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    order_id = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    purchase_order_item_id = table.Column<long>(type: "bigint", nullable: true),
                    ...
                    quantity_ordered = table.Column<decimal>(type: "numeric(18,4)", nullable: false),
                    quantity_manufactured = table.Column<decimal>(type: "numeric(18,4)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_delivery_note_items_quantity_delivered_max", "quantity_delivered <= quantity_manufactured");
                    table.CheckConstraint("CK_delivery_note_items_quantity_delivered_positive", "quantity_delivered > 0");
                    table.CheckConstraint("CK_delivery_note_items_quantity_manufactured", "quantity_manufactured >= 0");
                    table.CheckConstraint("CK_delivery_note_items_quantity_ordered", "quantity_ordered >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "idx_delivery_note_files_delivery_note_id",
            ...
            migrationBuilder.CreateIndex(
                name: "idx_delivery_notes_tracking_number",
                table: "delivery_notes",
